  ...
  return (
    <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4">
      <motion.div
        ...
        className="max-w-lg w-full bg-slate-800/50 backdrop-blur-xl border border-slate-700/50 p-8 rounded-3xl shadow-2xl"
      >
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 mt-2">What would you like to practice today?</p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          {LANGUAGES.map((lang, i) => (
            <motion.button
              ...
              className="group flex flex-col items-center gap-2 py-5 px-4 rounded-2xl border border-slate-700 bg-slate-900/50 text-slate-300 hover:border-blue-500 hover:bg-blue-500/10 hover:text-blue-300 transition-all duration-200 hover:shadow-lg hover:shadow-blue-500/5"
            >
