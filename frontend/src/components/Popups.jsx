...
export function InlineFeedbackPopup({ 
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
      <div className="bg-slate-900 border border-slate-700 shadow-2xl rounded-2xl p-6 w-full max-w-md backdrop-blur-md flex flex-col max-h-[90vh]">
        ...
        <div className="flex-1 overflow-y-auto space-y-4 mb-4 pr-2">
          ...
          {tutorChatHistory.length > 0 && (
            <div className="mt-6 pt-6 border-t border-slate-800 space-y-4">
              <div className="text-xs font-bold text-slate-500 uppercase tracking-wider mb-4">Tutor Chat</div>
              ...
              {isTutorTyping && (
                <div className="flex justify-start">
                  <div className="max-w-[85%] p-3 rounded-xl text-sm bg-slate-800 text-slate-200 rounded-tl-none border border-slate-700 flex items-center gap-2">
        ...
        <form onSubmit={sendTutorMessage} className="flex gap-2 shrink-0 border-t border-slate-800 pt-4">
          <input
            type="text"
            value={tutorInput}
          ...
          <button
            ...
            className="w-10 h-10 bg-blue-600 hover:bg-blue-500 disabled:bg-slate-800 disabled:text-slate-500 text-white rounded-xl flex items-center justify-center transition-all"
          >
